 ...
 * @generated
 */
public class SecurityTestSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case SecurityTestPackage.TARGET_OF_EVALUATION: {
				TargetOfEvaluation targetOfEvaluation = (TargetOfEvaluation)theEObject;
				T result = caseTargetOfEvaluation(targetOfEvaluation);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case SecurityTestPackage.AUTH_SETTING: {
				AuthSetting authSetting = (AuthSetting)theEObject;
				T result = caseAuthSetting(authSetting);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Target Of Evaluation</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Target Of Evaluation</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseTargetOfEvaluation(TargetOfEvaluation object) {
		return null;
	}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Auth Setting</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Auth Setting</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseAuthSetting(AuthSetting object) {
		return null;
	}
